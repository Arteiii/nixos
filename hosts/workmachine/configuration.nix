...

{
  ...
  networking.hostName = "nixos"; # Dene your hostname.
  # networking.wireless.enable = true;  # Enables wireless support via wpa_supplicant.

  # Congure network proxy if necessary
  ...
  # Some programs need SUID wrappers, can be congured further or are
  ...
  # Open ports in the rewall.
  # networking.rewall.allowedTCPPorts = [ ... ];
  # networking.rewall.allowedUDPPorts = [ ... ];
  # Or disable the rewall altogether.
  # networking.rewall.enable = false;
